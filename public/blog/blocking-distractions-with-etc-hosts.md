...
featured_image: "/images/blocking-distractions-with-etc-hosts.cover.png"
...
![/etc/hosts file blocking distracting websites](/images/blocking-distractions-with-etc-hosts-1.png)

And when I try to visit YouTube in my browser, this is what I see:

![YouTube blocked in browser](/images/blocking-distractions-with-etc-hosts-2.png)
...
![Sapiens book - my current reading](/images/blocking-distractions-with-etc-hosts-3.png)
